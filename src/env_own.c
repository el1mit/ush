...
int env_own(t_flags_env *flags, char **data) {

    escape_sequences(&data);
    ...
    if (data[1] == NULL) {
        ...
        if (flags->flag_I) {
            ...
            if (child_pid == 0) {
                ...
                t_jobs *new_process = jobs_create(child_pid, data[3]);
            ...
            if (data[2] != NULL) {
                ...
                create_process_own(data[3], data + 3, data[3]);
                return 0;
            }
        }
            ...
            if (data[1] != NULL) {
                create_process_own(data[1], data + 1, data[1]);
            }
        }
    }
    return 0;
